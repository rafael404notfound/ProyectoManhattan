...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ProyectoManhattan.MAUI.dll" comes first in this list. */
		"ProyectoManhattan.MAUI.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"ProyectoManhattan.Application.dll",
		"ProyectoManhattan.BlazorComponents.dll",
		"ProyectoManhattan.Domain.dll",
